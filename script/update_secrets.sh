...
for f in database.yml admin_usernames.yml manager_usernames.yml doi.yml solr.yml fedora.yml redis.yml recipients_list.yml smtp_config.yml service_dn.yml; do
    echo "=-=-=-=-=-=-=-= copy $f"
